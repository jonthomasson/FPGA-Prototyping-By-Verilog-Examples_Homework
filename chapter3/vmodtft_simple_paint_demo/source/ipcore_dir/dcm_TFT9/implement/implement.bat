...
xst -ifn xst.scr
move dcm_TFT9_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\dcm_TFT9.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_TFT9.ucf dcm_TFT9_exdes

echo 'Running map'
map -timing -pr b dcm_TFT9_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm_TFT9_exdes -w routed.ncd routed.vhd
cd ..
